...
ABS_APP_PATH = os.path.join(root_dir, "usecase3/usecase3_app.py")

@patch("usecase3.usecase3.get_summary_metrics")
@patch("usecase3.usecase3.plot_feature_importance_from_csv")
def test_app_initial_load(_mock_plot, mock_metrics):
    ...
    at = AppTest.from_file(ABS_APP_PATH).run()
...
@patch("usecase3.usecase3.get_summary_metrics")
@patch("usecase3.usecase3.load_failed_queries")
